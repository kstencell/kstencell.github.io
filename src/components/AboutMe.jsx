                ...
                <Row className='p-0 m-0 about-me-row' data-aos="fade-up" data-aos-delay="0" data-aos-easing="ease" data-aos-duration="500">
                    ...
                    <Container className='col-md-6 col-lg-8 col-xl-9 p-3 m-0 about-me-text-column d-flex flex-column'>
                        ...
                        <Row className='m-0 description-row'>
                            ...
                            <Row className='pb-3'>Currently entering my 3rd year in the Bachelor of Computer Science (Honours) degree program at Conestoga College.</Row>
